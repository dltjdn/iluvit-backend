...
//    }
    ...
    static class InitService{
        ...
        public void dbInit() {
            ...
            // 선생 추가
            Teacher teacher1 = Teacher.createTeacher("asd", "asd", encoder.encode("asd"), "01025655898", false, "asd@asd.com", "asd", Auth.TEACHER, Approval.WAITING, center1);
            ...
            Teacher teacher5 = Teacher.createTeacher("sss", "sss", encoder.encode("asd"), "sss5", false, "sss@sss.com", "sss", Auth.DIRECTOR, Approval.WAITING, center2);
            em.persist(teacher1);
            em.persist(teacher2);
            em.persist(teacher3);
            em.persist(teacher4);
