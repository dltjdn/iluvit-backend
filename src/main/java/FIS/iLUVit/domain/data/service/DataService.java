package FIS.iLUVit.domain.data.service;

import FIS.iLUVit.domain.data.dto.ChildHouseInfoResponse;
import FIS.iLUVit.domain.data.dto.ChildHouseInfoResponseWrapper;
import FIS.iLUVit.domain.data.dto.KindergartenGeneralResponseParam;
import FIS.iLUVit.domain.data.dto.KindergartenTeacherResponseParam;
import FIS.iLUVit.domain.data.domain.Region;
import FIS.iLUVit.domain.data.exception.DataErrorResult;
import FIS.iLUVit.domain.data.exception.DataException;
import FIS.iLUVit.domain.center.repository.CenterRepository;
import FIS.iLUVit.domain.data.repository.RegionRepository;
