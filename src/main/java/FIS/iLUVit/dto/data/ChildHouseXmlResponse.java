...
public class ChildHouseXmlResponse {
    ...
    private Integer dur12;                  // 근속년수 1년 이상 2년 미만 교사수
    @XmlElement(name = "EM_CNT_2Y")
    private Integer dur24;                  // 근속년수 2년 이상 4년 미만 교사수
    @XmlElement(name = "EM_CNT_4Y")
    private Integer dur46;                  // 근속년수 4년 이상 6년 미만 교사수
    @XmlElement(name = "EM_CNT_6Y")
    private Integer dur6_;                  // 근속년수 6년 이상 교사수
}
