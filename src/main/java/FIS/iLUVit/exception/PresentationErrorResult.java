...
public enum PresentationErrorResult implements ErrorResult {
    ...
    NO_RESULT(HttpStatus.BAD_REQUEST, "올바르지 않은 접근입니다"),
    DELETE_FAIL_HAS_PARTICIPANT(HttpStatus.UNAVAILABLE_FOR_LEGAL_REASONS, "설명회를 신청한 사용자가 있어 설명회 회차를 삭제할 수 없습니다."),
