...
public enum CommentErrorResult implements ErrorResult {
    ...
    NO_EXIST_COMMENT(HttpStatus.I_AM_A_TEAPOT, "해당 아이디를 가진 댓글이 존재하지 않습니다."),
    ...
    UNAUTHORIZED_USER_ACCESS_HEART(HttpStatus.FORBIDDEN, "좋아요 권한이 없는 비회원 유저입니다."),
    ALREADY_EXIST_HEART(HttpStatus.BAD_REQUEST, "이미 좋아요한 댓글입니다."),
    NO_EXIST_COMMENT_HEART(HttpStatus.I_AM_A_TEAPOT, "해당 아이디를 가진 좋아요가 존재하지 않습니다."),
