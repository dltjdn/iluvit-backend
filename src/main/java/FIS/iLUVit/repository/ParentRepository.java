...
public interface ParentRepository extends JpaRepository<Parent, Long> {
     ...
     */
    @Query("select new FIS.iLUVit.dto.participation.ParticipationDto(" +
    ...
    Slice<ParticipationDto> findMyJoinParticipation(@Param("userId") Long userId, Pageable pageable);
    ...
    Slice<ParticipationDto> findMyCancelParticipation(@Param("userId") Long userId, Pageable pageable);
