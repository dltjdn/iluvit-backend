...
/**
 * QChildHouse is a Querydsl query type for ChildHouse
 */
@Generated("com.querydsl.codegen.DefaultEntitySerializer")
public class QChildHouse extends EntityPathBase<ChildHouse> {

    private static final long serialVersionUID = 719842829L;

    private static final PathInits INITS = PathInits.DIRECT2;

    public static final QChildHouse childHouse = new QChildHouse("childHouse");
    ...
    public QChildHouse(String variable) {
        this(ChildHouse.class, forVariable(variable), INITS);
    }

    public QChildHouse(Path<? extends ChildHouse> path) {
        this(path.getType(), path.getMetadata(), PathInits.getFor(path.getMetadata(), INITS));
    }

    public QChildHouse(PathMetadata metadata) {
        this(metadata, PathInits.getFor(metadata, INITS));
    }

    public QChildHouse(PathMetadata metadata, PathInits inits) {
        this(ChildHouse.class, metadata, inits);
    }

    public QChildHouse(Class<? extends ChildHouse> type, PathMetadata metadata, PathInits inits) {
