...
echo "> Start health check of WAS at 'http://52.79.160.33:${TARGET_PORT}' ..."
...
do
    ...
    RESPONSE_CODE=$(curl -s -o /dev/null -w "%{http_code}"  http://52.79.160.33:${TARGET_PORT}/actuator/health)
